 ...
 *
 * @license
 *  GPLv2. The original library http://code.google.com/p/mimeparse/ is licensed
 *  under the MIT license. I would encourage anyone who wants to contribute to
 *  the mimeparse project to contact the maintainers over at google code. All
 *  in the spirit of open source and sharing.
 *    /Hugo Wetterberg
 */
class Mimeparse {
    /**
