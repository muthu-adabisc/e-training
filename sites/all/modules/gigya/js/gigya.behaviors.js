...
(function ($) {
    ...
    Drupal.behaviors.gigyaCheckLoginStatus = {
        attach: function (context, settings) {
            if (typeof gigya !== 'undefined') {
                try {
                    Drupal.behaviors.gigyaLogut.attach(context,settings);
                    var getAccountInfoResponse = function (response) {
                        if (typeof response !== 'undefined') {
                            Drupal.gigya.isGigyaLogedIn = response.errorCode === 0;
                            if (Drupal.settings.gigyaExtra.sessionMode == 'gigya') {
                                if (Drupal.gigya.isGigyaLogedIn && !Drupal.settings.gigyaExtra.isLogin) {
                                    Drupal.gigya.raasRegLogin(response);
                                } else if (!Drupal.gigya.isGigyaLogedIn && Drupal.settings.gigyaExtra.isLogin) {
