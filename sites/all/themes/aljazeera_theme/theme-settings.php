 ...
 *   The form state.
 */
function aljazeera_theme_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['prof_color_settings']['color_scheme'] = array(
    '#type'          => 'select',
    '#title'         => t('Color Scheme'),
    '#default_value' => theme_get_setting('color_scheme', 'aljazeera_theme'),
  ...
  $form['prof_settings']['breadcrumbs'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumbs','aljazeera_theme'),
  ...
  $form['prof_settings']['top_social_link']['social_links'] = array(
    ...
    '#default_value' => theme_get_setting('social_links', 'aljazeera_theme'),
